...
export declare type UpdateMyItemInputValues = {
    title?: string;
    description?: string;
    email?: string;
    phone?: string;
...
export declare type UpdateMyItemValidationValues = {
...
export declare type UpdateMyItemOverridesProps = {
    UpdateMyItemGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type UpdateMyItemProps = React.PropsWithChildren<{
    overrides?: UpdateMyItemOverridesProps | undefined | null;
} & {
    id?: string;
    item?: any;
    onSubmit?: (fields: UpdateMyItemInputValues) => UpdateMyItemInputValues;
    onSuccess?: (fields: UpdateMyItemInputValues) => void;
    onError?: (fields: UpdateMyItemInputValues, errorMessage: string) => void;
    onChange?: (fields: UpdateMyItemInputValues) => UpdateMyItemInputValues;
    onValidate?: UpdateMyItemValidationValues;
} & React.CSSProperties>;
export default function UpdateMyItem(props: UpdateMyItemProps): React.ReactElement;
